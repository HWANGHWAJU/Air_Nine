		...
		<div class="layer_inner">
			<div class="layer_content">
				...
				<div class="tab_section_slide tab_2w">
					<ul class="js-tab-section" id="ulTabSection">	<li class="on" id="liJourney_1"> 			<div class="tab_area">  			<h2 class="tab_title" onclick="javascript:fn_clickTabJourneyBag(this)" id="h2Journey_1" segmentno="1"><a href="#none" class="flight-from"><span class="icon-flight-from"></span>가는여정</a></h2> 				<div class="tab_content"> 					<div class="extraservice baggage"> 						<div class="left js-scroll-height" style="height: 901px;">	<div class="baggage-info"> 		<h3 class="title">수하물 서비스 추가 안내</h3> 		<div class="baggage-impact">무료 수하물 허용량: 1개(23kg)</div>		<ul class="uList01">			<li>승객(성인/소아) 1인당 1개(최대23kg) 무료 수하물이 허용이 가능하며, 수하물 추가가 필요하신 경우 유료로 구매하실 수 있습니다.</li>			<li>여정 변경시에는 구매하신 유료 초과 수하물은 자동 취소 및 환불 됩니다.(단, 출발 3일 전에는 환불 불가함)</li>			<li>유료 추가 수하물은 구간당 구매 가능하며, 탑승객 1인당 최대3개까지 구매 가능합니다.</li>			<li>유료 추가 수하물 1개의 무게는 최대23kg를 초과하실 수 없으며,기본 무게(최대23kg) 및 크기 초과시 공항에서 추가 요금이 부과됩니다.</li>			<li>유료 초과 수하물은 구매하신 승객께서 사용하셔야 하며, 다른 고객께 양도하실 수 없습니다.</li>		</ul>	</div> </div> 						<div class="right js-scroll-height" style="height: 901px;"> 							<div class="layer_title"> 						<h3 class="slide-heading-type01">수하물선택(가는여정)</h3> 							</div> 						<div class="journey"> 							<span class="icon_flight_from01" id="spanFightFrom_1">가는여정</span> 오사카/간사이(KIX)								<span class="icon_oneway01" id="spanFightTo_1"></span>서울/인천(ICN)&nbsp;2017.09.12 (화)&nbsp;13:55							</div> 							<ul class="total-list" id="JourneyPaxTotalList_1"><li class="active" id="passengerNo_1_1" segmentno="1" paxno="1"><span class="name" title="성명">JUNG/HEAWON</span><span class="number-select-area js-number-select" title="수하물"><span class="middle-txt">추가개수</span><input type="hidden" value="0"><ul class="number-select"><li><button id="buttonBag_1_1_1" title="JUNG/HEAWON 1개 추가" value="1" segmentno="1" paxno="1" onclick="javascript:fn_setBagInfo(this)" amount="8000">1</button></li><li><button id="buttonBag_1_1_2" title="JUNG/HEAWON 2개 추가" value="2" segmentno="1" paxno="1" onclick="javascript:fn_setBagInfo(this)" amount="8000">2</button></li><li><button id="buttonBag_1_1_3" title="JUNG/HEAWON 3개 추가" value="3" segmentno="1" paxno="1" onclick="javascript:fn_setBagInfo(this)" amount="8000">3</button></li></ul></span><span class="price" title="가격">-</span></li></ul> 							<div class="total-price" id="JourneyPriceTotalList_1"> 							<em class="total-title">가는여정 총액</em> 								<span class="price-area"> 									<span class="unit"></span> 									<span class="price"></span> 								</span> 							</div> 							<div class="mgt30 tc"> 								<a href="javascript:void(0);" onclick="javascript:fn_ClickConfirmBagBtn();return false;" class="btn-type01-col01 confirm">확인</a> 							</div> 						</div> 					</div> 				</div> 			</div> 		</li> 	<li id="liJourney_2"> 			<div class="tab_area"> 			<h2 class="tab_title" onclick="javascript:fn_clickTabJourneyBag(this)" id="h2Journey_2" segmentno="2"><a href="#none" class="flight-to"><span class="icon-flight-to"></span>오는여정</a></h2> 				<div class="tab_content"> 					<div class="extraservice baggage"> 						<div class="left js-scroll-height" style="height: 901px;">	<div class="baggage-info"> 		<h3 class="title">수하물 서비스 추가 안내</h3> 		<div class="baggage-impact">무료 수하물 허용량: 1개(23kg)</div>		<ul class="uList01">			<li>승객(성인/소아) 1인당 1개(최대23kg) 무료 수하물이 허용이 가능하며, 수하물 추가가 필요하신 경우 유료로 구매하실 수 있습니다.</li>			<li>여정 변경시에는 구매하신 유료 초과 수하물은 자동 취소 및 환불 됩니다.(단, 출발 3일 전에는 환불 불가함)</li>			<li>유료 추가 수하물은 구간당 구매 가능하며, 탑승객 1인당 최대3개까지 구매 가능합니다.</li>			<li>유료 추가 수하물 1개의 무게는 최대23kg를 초과하실 수 없으며,기본 무게(최대23kg) 및 크기 초과시 공항에서 추가 요금이 부과됩니다.</li>			<li>유료 초과 수하물은 구매하신 승객께서 사용하셔야 하며, 다른 고객께 양도하실 수 없습니다.</li>		</ul>	</div> </div> 						<div class="right js-scroll-height" style="height: 901px;"> 							<div class="layer_title"> 						<h3 class="slide-heading-type01">수하물선택(오는여정)</h3> 							</div> 						<div class="journey"> 							<span class="icon_flight_to01" id="spanFightFrom_2">오는여정</span> 서울/인천(ICN)								<span class="icon_oneway01" id="spanFightTo_2"></span>오사카/간사이(KIX)&nbsp;2017.09.13 (수)&nbsp;13:40							</div> 							<ul class="total-list" id="JourneyPaxTotalList_2"><li class="active" id="passengerNo_2_1" segmentno="2" paxno="1"><span class="name" title="성명">JUNG/HEAWON</span><span class="number-select-area js-number-select" title="수하물"><span class="middle-txt">추가개수</span><input type="hidden" value="0"><ul class="number-select"><li><button id="buttonBag_2_1_1" title="JUNG/HEAWON 1개 추가" value="1" segmentno="2" paxno="1" onclick="javascript:fn_setBagInfo(this)" amount="8000">1</button></li><li><button id="buttonBag_2_1_2" title="JUNG/HEAWON 2개 추가" value="2" segmentno="2" paxno="1" onclick="javascript:fn_setBagInfo(this)" amount="8000">2</button></li><li><button id="buttonBag_2_1_3" title="JUNG/HEAWON 3개 추가" value="3" segmentno="2" paxno="1" onclick="javascript:fn_setBagInfo(this)" amount="8000">3</button></li></ul></span><span class="price" title="가격">-</span></li></ul> 							<div class="total-price" id="JourneyPriceTotalList_2"> 							<em class="total-title">오는여정 총액</em>  								<span class="price-area"> 									<span class="unit"></span> 									<span class="price"></span> 								</span> 							</div> 							<div class="mgt30 tc"> 								<a href="javascript:void(0);" onclick="javascript:fn_ClickConfirmBagBtn();return false;" class="btn-type01-col01 confirm">확인</a> 							</div> 						</div> 					</div> 				</div> 			</div> 		</li> </ul>
				</div>
			</div>
			<!--  e:내용 -->
			<p class="btn_close"><a href="#none" class="jsCloseBtn" id="BagLayerClose" title="수하물선택 레이어 닫기">닫기</a></p>
		</div>
	</div>
</div>
<script type="text/javascript">
	var jsBagSelectScreenText;
	var jsLangCode = 'KO';
	var jsBagJsonUrl = '/lang/homepage/layer/BaggageSelect.json';
	
	var jsAirBagRequestInfo = null;				// 수하물 정보 조회 결과
	var jsAirBagChargeArray = new Array();		// 선택된 여정의 수하물 운임 정보
	var jsBagCurrency = "";						// 수하물 운임 Currency
	var jsBagSelectedSegInfo = null;			// 현재 선택된 여정 정보
	var jsArrAdminBagChargeReq	= [];			// 관리자가 수하물 운임을 등록했는지 확인하기 위한 조건
	var jsBagADTCHDCnt = 0;					// 성인,소아 탑승객의 수
	
	$(document).ready(function(){
		jsBagSelectScreenText = $.cfn_getProgramScreenText(jsLangCode, jsBagJsonUrl); // 화면 텍스트 가져오기
		$.cfn_setProgramScreenText(jsBagSelectScreenText); // 가져온 텍스트 화면에 설정
		...
		fn_drawBagHeader(jsPNRDataObj.segmentDatas);	// 여정 갯수만큼 탭을 구성한다
		fn_drawPaxDataOfBag();							// 탑승객의 수만큼 반복하여 탑승객 목록 구성
		fn_drawBagRequest();							// ajax 실행전 여정의 정보를 구성 : jsAirBagRequestInfo 변수로 데이터를 만들어줌
		fn_searchBagCharge();							// 여정별 수하물 운임 조회
		
	}); // end document ready 
	
	/*==========================================================================
	// 예약 단계에서 이미 수하물을 구매한 경우
	==========================================================================*/
	function fn_setBuyBag(){
		for (var i=0; i< jsPNRDataObj.ancillaryDatas.length; i++) {
			if (jsPNRDataObj.ancillaryDatas[i].serviceCode == "PDBG") {
				var _title = $('#buttonBag_'+jsPNRDataObj.ancillaryDatas[i].segmentNo+'_'+jsPNRDataObj.ancillaryDatas[i].passengerNo+'_'+jsPNRDataObj.ancillaryDatas[i].bagCnt).attr("title");
				// 이미 구매한 수하물 금액 셋팅
				...
				// 이미 구매한 수하물 갯수 셋팅
				$('#buttonBag_'+jsPNRDataObj.ancillaryDatas[i].segmentNo+'_'+jsPNRDataObj.ancillaryDatas[i].passengerNo+'_'+jsPNRDataObj.ancillaryDatas[i].bagCnt).parent().addClass('active');
				// 수하물 갯수 버튼 수정 금지
				$('#passengerNo_'+jsPNRDataObj.ancillaryDatas[i].segmentNo+'_'+jsPNRDataObj.ancillaryDatas[i].passengerNo).find('button').removeAttr('onclick');
				$('#passengerNo_'+jsPNRDataObj.ancillaryDatas[i].segmentNo+'_'+jsPNRDataObj.ancillaryDatas[i].passengerNo).find("li").off("click");					// 버튼 이벤트 금지
				$('#passengerNo_'+jsPNRDataObj.ancillaryDatas[i].segmentNo+'_'+jsPNRDataObj.ancillaryDatas[i].passengerNo).find("input[type=hidden]").val(jsPNRDataObj.ancillaryDatas[i].bagCnt);
				$('#buttonBag_'+jsPNRDataObj.ancillaryDatas[i].segmentNo+'_'+jsPNRDataObj.ancillaryDatas[i].passengerNo+'_'+jsPNRDataObj.ancillaryDatas[i].bagCnt).attr("title", _title + $.cfn_setText(jsBagSelectScreenText, "BagSelect"));
				$('#passengerNo_'+jsPNRDataObj.ancillaryDatas[i].segmentNo+'_'+jsPNRDataObj.ancillaryDatas[i].passengerNo).removeClass();
				$('#passengerNo_'+jsPNRDataObj.ancillaryDatas[i].segmentNo+'_'+jsPNRDataObj.ancillaryDatas[i].passengerNo).attr('bagStatus','EMD');
		...
		// 선택 가능한 사용자에 대해 선택권을 부여한다.
     	for (var j=0; j< jsPNRDataObj.passengerDatas.length; j++) {
     		var jsBagStatus = $('#passengerNo_'+jsPNRDataObj.segmentDatas[0].segmentNo+'_'+jsPNRDataObj.passengerDatas[j].passengerNo).attr('bagStatus');
     		if(jsBagStatus == undefined){
     			$("#passengerNo_" + jsPNRDataObj.segmentDatas[0].segmentNo + "_" + jsPNRDataObj.passengerDatas[j].passengerNo).attr('class','active');
    			break;
     		}
     	}
	...
	/*==========================================================================
	// 수하물 조회 ajax 실행전 여정의 정보를 구성
	==========================================================================*/
	function fn_drawBagRequest() {
		var jsSegmentNo = "";
		var jsDepAirport = "";
		var jsArrAirport = "";
		var jsDepDate = "";
		...
		// service 호출 후 응답받을 jsAirBagRequestInfo 변수로 지정
		jsAirBagRequestInfo = {
			USE_CURRENCY : jsPNRDataObj.USE_CURRENCY, 
			LANGUAGE_CODE : jsPNRDataObj.LANGUAGE_CODE
		};
		jsAirBagRequestInfo.bagSegmentInfo = new Array();
		
		for (var i=0; i < jsPNRDataObj.segmentDatas.length; i++) {
			for (var j=0; j < jsBagAbleSegmentData.length; j++) {
				if (jsPNRDataObj.segmentDatas[i].segmentNo == jsBagAbleSegmentData[j].segmentNo) {
					if (jsBagAbleSegmentData[j].ancillaryAble == 'Y') {
						var jsBagSegmentInfoData = {
							...
							"bagInfo" 			: new Array(),
							"bagPassengerInfo"  : new Array()
						};
						jsAirBagRequestInfo.bagSegmentInfo.push(jsBagSegmentInfoData);
						...
						jsArrAdminBagChargeReq.push(bagReqData);
	...
	// 여정별 수하물 운임 조회
	==========================================================================*/
	function fn_searchBagCharge(){
		$.ajax({
			type:'POST',
			cache : false,
			dataType : 'json',
			url : '/I/' + jsLangCode + '/searchBagCharge.do',
        	data:{	
        		AdminBagChargeReqData : JSON.stringify(jsArrAdminBagChargeReq)
        	},
        	success:function(data){
        		// 여정별 수하물 운임 조회 후 화면에 출력
        		fn_drawBagChargeList(data);
        		
				// 현재 활성화된 여정탭 정보만 추출
				fn_setCurrentSegmentBagInfo();
				
				// 예약 상세 단계
				if(jsProcessType == "EMD"){
					fn_setBuyBag();	// 예약 단계에서 이미 수하물을 구매한 경우
				} 
        	},
        	error:function(request,status,error){
        		console.log("code:"+request.status+"\n"+"message:"+request.responseText+"\n"+"error:"+error);
        		alert($.cfn_setText(jsBagSelectScreenText, "msgErrorWarning"));
        	}
        });
	}
	...
	// 여정별 수하물 운임 조회 후 화면에 출력
	==========================================================================*/
	function fn_drawBagChargeList(data){
		$('[name=bag_loading]').hide();
		
		jsBagCurrency = jsPNRDataObj.USE_CURRENCY;	// 통화단위
		var resultList = data.bagChargeList;
		
		$.each(resultList, function(idx, val) {
			
			if(resultList[idx].CNT > 0){
				
				$.each($("[id^=buttonBag_"+resultList[idx].SEGMENT_NO+"]"), function() {
					$(this).attr('amount',resultList[idx].CHARGE);
				});
				
				var jsResData = {
					currency 	: resultList[idx].CURRENCY,
					charge 		: resultList[idx].CHARGE,
					segmentNo 	: resultList[idx].SEGMENT_NO
				};
				jsAirBagRequestInfo.bagSegmentInfo[idx].bagInfo.push(jsResData);
				
				// 노선 및 구매시기 별 수하물 허용량 처리
				var baggageClass = "";
				var baggageTitle = "";
				var baggageDesc1 = "";
				var baggageDesc2 = "";
				...
				if(jsPNRDataObj.segmentDatas[0].arrivalAirport == "GUM"){
					baggageClass = "baggage-impact3";
					baggageTitle = $.cfn_setText(jsBagSelectScreenText, "TwoBag");
					baggageDesc1 = $.cfn_setText(jsBagSelectScreenText, "AddBagMsg6");
					baggageDesc2 = $.cfn_setText(jsBagSelectScreenText, "AddBagMsg4");
				} else {
					if(parseFloat(gsCurrentDateTime.substring(0,12)) < parseFloat("201707110000") ) { // 수하물 규정 23kg 적용
						baggageClass = "baggage-impact";
						baggageTitle = $.cfn_setText(jsBagSelectScreenText, "OneBag");
						baggageDesc1 = $.cfn_setText(jsBagSelectScreenText, "AddBagMsg1");
						baggageDesc2 = $.cfn_setText(jsBagSelectScreenText, "AddBagMsg4");						
					} else {
						baggageClass = "baggage-impact2";
						baggageTitle = $.cfn_setText(jsBagSelectScreenText, "OneBagNew");
						baggageDesc1 = $.cfn_setText(jsBagSelectScreenText, "AddBagMsg7");
						baggageDesc2 = $.cfn_setText(jsBagSelectScreenText, "AddBagMsg8");		
					}
				}
				var backgroundHtml =  '	<div class="baggage-info"> '
									+ '		<h3 class="title">'+$.cfn_setText(jsBagSelectScreenText, "GuideBag")+'</h3> '
									+ '		<div class="'+baggageClass+'">'+baggageTitle+'</div>'
									+ '		<ul class="uList01">'
									+ '			<li>'+baggageDesc1+'</li>'
									+ '			<li>'+$.cfn_setText(jsBagSelectScreenText, "AddBagMsg2")+'</li>'
									+ '			<li>'+$.cfn_setText(jsBagSelectScreenText, "AddBagMsg3")+'</li>'
									+ '			<li>'+baggageDesc2+'</li>'
									+ '			<li>'+$.cfn_setText(jsBagSelectScreenText, "AddBagMsg5")+'</li>'
									+ '		</ul>'
									+ '	</div> '
				
				$('#liJourney_'+resultList[idx].SEGMENT_NO).find('div.left.js-scroll-height').html(backgroundHtml);
				
			} else {
				
				$("#liJourney_"+resultList[idx].SEGMENT_NO).find("div.left.js-scroll-height").html('<div class="baggage-info"><ul class="uList01"><li>'+$.cfn_setText(jsBagSelectScreenText, "msgErrorWarning1")+'<br />'+$.cfn_setText(jsBagSelectScreenText, "msgErrorWarning2")+'</li></ul></div>');
				$("#liJourney_"+resultList[idx].SEGMENT_NO).find('.price').empty();
				$("#liJourney_"+resultList[idx].SEGMENT_NO).find('.js-number-select').empty();
				
				// 관리자가 수하물 운임을 등록하지 않은 경우
				if ( $("#liJourney_"+resultList[idx].SEGMENT_NO).hasClass('on') ) {
					alert($.cfn_setText(jsBagSelectScreenText, "msgErrorWarning1")+'\n'+$.cfn_setText(jsBagSelectScreenText, "msgErrorWarning2"));
				}
			}
		});
		
		// 이전에 선택한 수하물 존재하는 경우 탑승객별 수하물 정보를 설정한다.
		if (jsAirBagAncillaryData.bagSegmentInfo != undefined) {
			// 이전에 선택한 수하물이 존재하는 경우 탑승객별 수하물 정보를 설정한다.
			for (var i=0; i < jsAirBagAncillaryData.bagSegmentInfo.length; i++) {
				for (var j=0; j < jsAirBagAncillaryData.bagSegmentInfo[i].bagPassengerInfo.length; j++) {
					jsBagSelectedSegInfo = jsAirBagAncillaryData.bagSegmentInfo[i];
					var bagCnt = jsAirBagAncillaryData.bagSegmentInfo[i].bagPassengerInfo[j].bagCnt;
					var segmentNo = jsAirBagAncillaryData.bagSegmentInfo[i].segmentNo;
					var passengerNo = jsAirBagAncillaryData.bagSegmentInfo[i].bagPassengerInfo[j].passengerNo;
					$("#buttonBag_"+segmentNo+"_"+passengerNo+"_"+bagCnt).trigger("click");
				}
			}
		}
	...
	// 현재 활성화된 여정탭 정보만 추출
	==========================================================================*/
	function fn_setCurrentSegmentBagInfo() {
		// 현재 활성화된 여정탭의 segmentNo 여정번호
		for (var i=0; i < jsAirBagRequestInfo.bagSegmentInfo.length; i++) {
			if ( $("#liJourney_"+jsAirBagRequestInfo.bagSegmentInfo[i].segmentNo).hasClass('on') ) {
				jsBagSelectedSegInfo = jsAirBagRequestInfo.bagSegmentInfo[i];
				
				// 선택한 사용자 이외의 사용자에 대한 선택권을 제어한다.
				$.each($("[id^=passengerNo_"+jsAirBagRequestInfo.bagSegmentInfo[i].segmentNo+"_]"), function() {
					$(this).removeClass("active");
				});
				
				if(jsBagSelectedSegInfo.bagInfo != ""){
					// 해당 여정의 첫번째 탑승객에게 선택권을 부여한다.
					$("#JourneyPaxTotalList_"+jsAirBagRequestInfo.bagSegmentInfo[i].segmentNo).find("li:eq(0)").addClass("active");
				}
				...
				if (jsPNRDataObj.segmentDatas[i].segmentNo == jsBagAbleSegmentData[j].segmentNo) {
					if (jsBagAbleSegmentData[j].ancillaryAble == 'Y') {
						...
						for (var k=0; k < jsPNRDataObj.passengerDatas.length; k++) {
							// 성인 또는 소아 탑승객의 경우에만 수하물을 선택할 수 있음
							if (jsPNRDataObj.passengerDatas[k].paxType != "INF") {
								
								if (k == 0){
									paxTag += '<li class="active" id="passengerNo_'+jsPNRDataObj.segmentDatas[i].segmentNo+ "_" + jsPNRDataObj.passengerDatas[k].passengerNo+'" segmentNo="' + jsPNRDataObj.segmentDatas[i].segmentNo + '" paxNo="' + jsPNRDataObj.passengerDatas[k].passengerNo + '" >';
								}else{
									paxTag += '<li id="passengerNo_'+jsPNRDataObj.segmentDatas[i].segmentNo+ "_" + jsPNRDataObj.passengerDatas[k].passengerNo+'" segmentNo="' + jsPNRDataObj.segmentDatas[i].segmentNo + '" paxNo="' + jsPNRDataObj.passengerDatas[k].passengerNo + '" >';
								}
								
								paxTag += 	'<span class="name" title="'+$.cfn_setText(jsBagSelectScreenText, "Name")+'">'+jsPNRDataObj.passengerDatas[k].paxName+'</span>' +
											'<span class="number-select-area js-number-select" title="'+$.cfn_setText(jsBagSelectScreenText, "Bag")+'">' +
												'<span class="middle-txt">'+$.cfn_setText(jsBagSelectScreenText, "AddCnt")+'</span>' +
												'<input type="hidden" value="0" />' +
												'<ul class="number-select">' +
													'<li><button id="buttonBag_'+jsPNRDataObj.segmentDatas[i].segmentNo+'_'+jsPNRDataObj.passengerDatas[k].passengerNo+'_1" title="'+jsPNRDataObj.passengerDatas[k].paxName+' 1'+$.cfn_setText(jsBagSelectScreenText, "UnitAddCnt")+'" value="1" segmentNo="' + jsPNRDataObj.segmentDatas[i].segmentNo + '" paxNo="' + jsPNRDataObj.passengerDatas[k].passengerNo + '" onclick="javascript:fn_setBagInfo(this)">1</button></li>' +
													'<li><button id="buttonBag_'+jsPNRDataObj.segmentDatas[i].segmentNo+'_'+jsPNRDataObj.passengerDatas[k].passengerNo+'_2" title="'+jsPNRDataObj.passengerDatas[k].paxName+' 2'+$.cfn_setText(jsBagSelectScreenText, "UnitAddCnt")+'" value="2" segmentNo="' + jsPNRDataObj.segmentDatas[i].segmentNo + '" paxNo="' + jsPNRDataObj.passengerDatas[k].passengerNo + '" onclick="javascript:fn_setBagInfo(this)">2</button></li>' +
													'<li><button id="buttonBag_'+jsPNRDataObj.segmentDatas[i].segmentNo+'_'+jsPNRDataObj.passengerDatas[k].passengerNo+'_3" title="'+jsPNRDataObj.passengerDatas[k].paxName+' 3'+$.cfn_setText(jsBagSelectScreenText, "UnitAddCnt")+'" value="3" segmentNo="' + jsPNRDataObj.segmentDatas[i].segmentNo + '" paxNo="' + jsPNRDataObj.passengerDatas[k].passengerNo + '" onclick="javascript:fn_setBagInfo(this)">3</button></li>' +
												'</ul>' +
											'</span>' +
											'<span class="price" title="'+$.cfn_setText(jsBagSelectScreenText, "Price")+'">-</span>' +
										  '</li>';
								if (!jsPaxCntInit) {
									jsBagADTCHDCnt++;
								}		  
	...
	/*---------------------------------------------------------------------------
	// 수하물 추가개수를 선택할 탑승객을 선택한다.
	-----------------------------------------------------------------------------*/
	function fn_setBagInfo(obj) {
		var choicePaxNo 	= $(obj).attr('paxNo');			// 선택한 승객번호
		var choiceSegmentNo = $(obj).attr('segmentNo'); 	// 선택한 여정번호		
		var choiceAmount 	= $(obj).attr('amount');		// 1개당 수하물 가격			
		var choiceBagCnt 	= $(obj).attr('value');			// 수하물 갯수
		
		// 선택한 사용자 이외의 사용자에 대한 선택권을 제어한다.
		$.each($("[id^=passengerNo_"+choiceSegmentNo+"_]"), function() {
			$(this).removeClass("active");
			$(this).closest(".js-number-select").find("input[type=hidden]").val(0);
		});
		
		// 현재 선택한 사용자에게 수하물선택권을 부여한다.
		$("#passengerNo_"+choiceSegmentNo+"_"+choicePaxNo).addClass("active");
		
		var jsTmpPaxType = "";
		var jsTmpPaxName = "";
		for (var i=0; i < jsPNRDataObj.passengerDatas.length; i++) {
			if (jsPNRDataObj.passengerDatas[i].passengerNo == choicePaxNo) {
		...
		// 기존에 선택된 탑승객 정보 제거
		for (var i=0; i < jsAirBagRequestInfo.bagSegmentInfo.length; i++) {
			if (jsAirBagRequestInfo.bagSegmentInfo[i].segmentNo == choiceSegmentNo) {
				for (var j=0; j < jsAirBagRequestInfo.bagSegmentInfo[i].bagPassengerInfo.length; j++) {
					if (jsAirBagRequestInfo.bagSegmentInfo[i].bagPassengerInfo[j].passengerNo == jsBagCurrentSelectPaxJSON.paxNo) {
						jsAirBagRequestInfo.bagSegmentInfo[i].bagPassengerInfo.splice(j, 1);
						break;
					}
				}
				break;
		...
		// 수하물운임 배열에 있던 기존 데이터 제거
		for (var i=0; i < jsAirBagRequestInfo.bagSegmentInfo.length; i++) {
			if (jsAirBagRequestInfo.bagSegmentInfo[i].segmentNo == choiceSegmentNo) {
				// 현재 활성화된 여정탭의 여정번호 : jsBagSelectedSegInfo.segmentNo
				for (var j=0; j< jsAirBagChargeArray.length; j++) {
					if (jsAirBagChargeArray[j].segmentNo == choiceSegmentNo) {
						if (jsAirBagChargeArray[j].passengerNo == jsBagCurrentSelectPaxJSON.paxNo) {
							jsAirBagChargeArray.splice(j, 1);
							break;
						}
					}
				}
		...
		if($(obj).parent().hasClass("active")){
			// 선택한 수하물을 재선택하는경우 운임가격이 초기화 되야 한다
			$("#passengerNo_"+choiceSegmentNo+"_"+choicePaxNo).find('span.price').html("-");
			
		} else {
			// 이전에 선택한적이 없는 경우
			var choiceBagTotalAmount = Number(choiceAmount * choiceBagCnt);	// 가격 * 갯수
			var choicePrice = $.cfn_setComma( choiceBagTotalAmount );		// ex) 50,000
			// 선택한 승객의 수하물 운임을 계산하여 출력
			$("#passengerNo_"+choiceSegmentNo+"_"+choicePaxNo).find('.price').text(choicePrice);					// 수하물 가격 셋팅
			$("#passengerNo_"+choiceSegmentNo+"_"+choicePaxNo).find("input[type=hidden]").val(choiceBagCnt);
			
			// 현재 선택된 탑승객 정보 
			var jsCurrentSelectPaxData = {
				passengerNo	 		: jsBagCurrentSelectPaxJSON.paxNo,
				passengerName		: jsBagCurrentSelectPaxJSON.paxName,
				bagCnt 				: choiceBagCnt,
				bagAmount	  		: choiceBagTotalAmount,
				segmentNo	 		: choiceSegmentNo,
				rphNo	 			: jsBagSelectedSegInfo.rphNo,
				flightNo	 		: jsBagSelectedSegInfo.flightNo,
				departureAirport	: jsBagSelectedSegInfo.departureAirport,
				arrivalAirport 	 	: jsBagSelectedSegInfo.arrivalAirport
			};
			
			for (var i=0; i < jsAirBagRequestInfo.bagSegmentInfo.length; i++) {
				if (jsAirBagRequestInfo.bagSegmentInfo[i].segmentNo == jsBagSelectedSegInfo.segmentNo) {
					jsAirBagRequestInfo.bagSegmentInfo[i].bagPassengerInfo.push(jsCurrentSelectPaxData);
				}
			}
			// 여정총액 배열에 넣기
			jsAirBagChargeArray.push(jsCurrentSelectPaxData);
			
			// 다음 탑승객 선택
			$("#JourneyPaxTotalList_" + choiceSegmentNo).find(">li").each(function(idx) {
				var jsPaxno = $(this).attr("paxno");
				
				if ($(this).hasClass("active") && (idx+1) < jsBagADTCHDCnt) {
					var jsBagStatus = $('#passengerNo_'+choiceSegmentNo+'_'+jsPaxno).attr('bagStatus');
					if($(this).next().attr('bagStatus') == undefined){
						// 현재 선택한 사용자의 다음 사용자에게 수하물선택권을 부여한다.
						$(this).removeClass("active");
		...
		// 여정총액 계산
		fn_bagCurrencyTotal(jsAirBagChargeArray);
	...
	// 수하물선택에 따른 여정 총액 계산
	-----------------------------------------------------------------------------*/
	function fn_bagCurrencyTotal(bagChargeArray) {
		// 선택한수하물의 가격 배열
		if(bagChargeArray.length == 0 ) {
			// 현재 활성화된 여정탭의 여정번호 : jsBagSelectedSegInfo.segmentNo
			$('#JourneyPriceTotalList_'+jsBagSelectedSegInfo.segmentNo).find('.unit').html("");
			$('#JourneyPriceTotalList_'+jsBagSelectedSegInfo.segmentNo).find('.price').html("");
			...
			for(var i=0; i< jsAirBagRequestInfo.bagSegmentInfo.length; i++){
				// 현재 선택된 여정
				if (jsAirBagRequestInfo.bagSegmentInfo[i].segmentNo == jsBagSelectedSegInfo.segmentNo) {
					var bagChargeSum = 0.0;
					for (var j=0; j < jsAirBagRequestInfo.bagSegmentInfo[i].bagPassengerInfo.length; j++) {
						bagChargeSum += Number(jsAirBagRequestInfo.bagSegmentInfo[i].bagPassengerInfo[j].bagAmount);
					}
					
					$('#JourneyPriceTotalList_'+jsBagSelectedSegInfo.segmentNo).find('.unit').html(jsBagCurrency);
					$('#JourneyPriceTotalList_'+jsBagSelectedSegInfo.segmentNo).find('.price').html( $.cfn_setComma(bagChargeSum) );
			...
			} // end jsAirBagRequestInfo.bagSegmentInfo.length
		}
	}
	...
	==========================================================================*/
	function fn_clickTabJourneyBag(obj) {
		...
		for (var i=0; i < jsAirBagRequestInfo.bagSegmentInfo.length; i++) {
			if ( jsAirBagRequestInfo.bagSegmentInfo[i].segmentNo == jsSegmentNo) {
				jsBagSelectedSegInfo = jsAirBagRequestInfo.bagSegmentInfo[i];
				if(jsAirBagRequestInfo.bagSegmentInfo[i].bagInfo == ""){
					alert($.cfn_setText(jsBagSelectScreenText, "msgErrorWarning1")+'\n'+$.cfn_setText(jsBagSelectScreenText, "msgErrorWarning2"));
				} else {
					// 수하물을 구매하지 않은 탑승객 중 첫번째 탑승객에게 선택권을 부여한다.
					var paxList = $("#JourneyPaxTotalList_"+jsAirBagRequestInfo.bagSegmentInfo[i].segmentNo).find(">li");
					for (var j=0; j < paxList.length; j++) {
						if ($(paxList).eq(j).attr("bagStatus") == undefined) {
							$(paxList).eq(j).addClass("active");
							break;
						}
					}
	...
	//여정 갯수만큼 탭 구성
	-----------------------------------------------------------------------------*/
	function fn_drawBagHeader(segmentDatas) {
		var bagHeaderTag = "";
		var firstSeq = 0;
		for(var i=0; i< segmentDatas.length; i++){
			for(var j=0; j< jsBagAbleSegmentData.length; j++){
				if(segmentDatas[i].segmentNo == jsBagAbleSegmentData[j].segmentNo){
					if(jsBagAbleSegmentData[j].ancillaryAble == 'Y'){	// 수하물선택이 가능한 여정만 보여준다
						if (firstSeq == 0) {	
							// 가는여정
							bagHeaderTag += '	<li class="on" id="liJourney_'+segmentDatas[i].segmentNo+'" > ';
						} else {
							// 오는여정
							bagHeaderTag += '	<li id="liJourney_'+segmentDatas[i].segmentNo+'" > ';
						}
						bagHeaderTag  += '			<div class="tab_area"> ';
										
						
						if(jsTripType == 'MT'){	// 여정타입 : 다구간
							// 여정1, 여정2 등
							bagHeaderTag += ' 				<h2 class="tab_title" onclick="javascript:fn_clickTabJourneyBag(this)" id="h2Journey_'+segmentDatas[i].segmentNo+'" segmentNo="'+segmentDatas[i].segmentNo+'"><a href="#none" class="flight-from"><span class="icon-flight-from"></span>'+$.cfn_setText(jsBagSelectScreenText, "Itinerary")+segmentDatas[i].segmentNo+'</a></h2> ';
						} else {				// 여정타입 : 왕복 또는 편도(RT,OW)
							if (segmentDatas[i].segmentNo == 1) {	
								// 가는여정
								bagHeaderTag += ' 			<h2 class="tab_title" onclick="javascript:fn_clickTabJourneyBag(this)" id="h2Journey_'+segmentDatas[i].segmentNo+'" segmentNo="'+segmentDatas[i].segmentNo+'"><a href="#none" class="flight-from"><span class="icon-flight-from"></span>'+$.cfn_setText(jsBagSelectScreenText, "lblDepartureItinerary")+'</a></h2> ';
							} else {
								// 오는여정
								bagHeaderTag += '			<h2 class="tab_title" onclick="javascript:fn_clickTabJourneyBag(this)" id="h2Journey_'+segmentDatas[i].segmentNo+'" segmentNo="'+segmentDatas[i].segmentNo+'"><a href="#none" class="flight-to"><span class="icon-flight-to"></span>'+$.cfn_setText(jsBagSelectScreenText, "lblArrivalItinerary")+'</a></h2> '; 
							}
						}
										
						bagHeaderTag  += '				<div class="tab_content"> '
										+ '					<div class="extraservice baggage"> '
										+ '						<div class="left js-scroll-height"> '
										+ '							<div name="bag_loading" class="loding_section" > '
						...
						if(jsTripType == 'MT'){	// 여정타입 : 다구간
							bagHeaderTag += '							<h3 class="slide-heading-type01">'+$.cfn_setText(jsBagSelectScreenText, "lblBagChoice")+'('+$.cfn_setText(jsBagSelectScreenText, "Itinerary")+segmentDatas[i].segmentNo+ ')'+'</h3> ';
						} else {
							if (segmentDatas[i].segmentNo == 1) {
								bagHeaderTag += '						<h3 class="slide-heading-type01">'+$.cfn_setText(jsBagSelectScreenText, "lblBagChoice")+'('+$.cfn_setText(jsBagSelectScreenText, "lblDepartureItinerary")+ ')'+'</h3> ';
							} else {
								bagHeaderTag += '						<h3 class="slide-heading-type01">'+$.cfn_setText(jsBagSelectScreenText, "lblBagChoice")+'('+$.cfn_setText(jsBagSelectScreenText, "lblArrivalItinerary")+ ')' +'</h3> ';
							}
						}
						...
						if(jsTripType == 'MT'){	// 여정타입 : 다구간
							// 여정1, 여정2 등
							bagHeaderTag += '								<span class="icon_flight_from01" id="spanFightFrom_'+segmentDatas[i].segmentNo+'">'+$.cfn_setText(jsBagSelectScreenText, "Itinerary")+segmentDatas[i].segmentNo+'</span> '+ segmentDatas[i].departureAirportName;
						} else {				// 여정타입 : 왕복 또는 편도(RT,OW)
							if (segmentDatas[i].segmentNo == 1) {	
								// 가는여정
								bagHeaderTag += '							<span class="icon_flight_from01" id="spanFightFrom_'+segmentDatas[i].segmentNo+'">'+$.cfn_setText(jsBagSelectScreenText, "lblDepartureItinerary")+'</span> '+ segmentDatas[i].departureAirportName;
							} else {
								// 오는여정
								bagHeaderTag += '							<span class="icon_flight_to01" id="spanFightFrom_'+segmentDatas[i].segmentNo+'">'+$.cfn_setText(jsBagSelectScreenText, "lblArrivalItinerary")+'</span> '+ segmentDatas[i].departureAirportName;
							}		
						}
										
						bagHeaderTag += '								<span class="icon_oneway01" id="spanFightTo_'+segmentDatas[i].segmentNo+'">'+$.cfn_setText(jsBagSelectScreenText, "lblFrom")+'</span>'+ segmentDatas[i].arrivalAirportName +'&nbsp;'+ moment(segmentDatas[i].departureDateTime.substr(0,8), "YYYYMMDD").locale(jsLangCode).format("YYYY.MM.DD [(]dd[)]") + '&nbsp;' +segmentDatas[i].departureDateTime.substr(8,2) + ':' + segmentDatas[i].departureDateTime.substr(10,2)
										+ '							</div> '
						...
						if(jsTripType == 'MT'){	// 여정타입 : 다구간
							// 여정1, 여정2 등
							bagHeaderTag += '								<em class="total-title" >'+$.cfn_setText(jsBagSelectScreenText, "Itinerary")+segmentDatas[i].segmentNo+'&nbsp;'+$.cfn_setText(jsBagSelectScreenText, "lblPredictionTotal")+'</em> ';
						} else {				// 여정타입 : 왕복 또는 편도(RT,OW)
							if (segmentDatas[i].segmentNo == 1) {	
								// 가는여정
								bagHeaderTag += '							<em class="total-title" >'+$.cfn_setText(jsBagSelectScreenText, "lblDepartureItineraryToTal")+'</em> ';
							} else {
								// 오는여정
								bagHeaderTag += '							<em class="total-title" >'+$.cfn_setText(jsBagSelectScreenText, "lblArrivalItineraryToTal")+'</em>  ';
							}
						}
										
						bagHeaderTag += '								<span class="price-area"> '
									  	+ '									<span class="unit"></span> '
									  	+ '									<span class="price"></span> '
									  	+ '								</span> '
									  	+ '							</div> '
										+ '							<div class="mgt30 tc"> '
										+ '								<a href="javascript:void(0);" onclick="javascript:fn_ClickConfirmBagBtn();return false;" class="btn-type01-col01 confirm" >'+$.cfn_setText(jsBagSelectScreenText, "lblConfirm")+'</a> '
										+ '							</div> '
										+ '						</div> '
										+ '					</div> '
										+ '				</div> '
		...
		$('#ulTabSection').html(bagHeaderTag);
	}
	...
	// 확인 버튼 클릭 시 레이어 닫기
	-----------------------------------------------------------------------------*/
	function fn_ClickConfirmBagBtn(){
		if ( $('#liJourney_'+jsBagSelectedSegInfo.segmentNo).next().has('li').length > 0 ) {
			$("#liJourney_"+jsBagSelectedSegInfo.segmentNo).next().find('h2.tab_title').trigger("click");
			
		} else {
			// 현재 활성화된 여정이 여정의 마지막인 경우
			$("a.jsCloseBtn").trigger("click");
			// Ancillary 메인 화면의 변수에 선택한 수하물 정보가 담겨진 데이터를 담는다.
			// jsAirBagRequestInfo : 최초에 한번 수하물 조회할때 변수로 담아놓음 (data.bagChargeList)
			jsAirBagAncillaryData = jsAirBagRequestInfo;
			
			if (jsProcessType == "RSV") {
				// 부가서비스 화면에 함수 호출
				fn_returnBagPassengerInfo();
			} else {
				fn_returnAddEmdBag();
			}
		}
